...
export default function Hero() {
  return (
    <section id="hero" className="section-padding relative flex min-h-screen flex-col justify-center pt-32">
      <div className="grid gap-12 lg:grid-cols-2">
        ...
        >
          ...
          <div>
            <h1 className="font-display text-4xl leading-tight text-white sm:text-5xl lg:text-6xl">Omer Asik</h1>
        ...
        >
          <div className="relative h-80 w-80 rounded-full border border-white/10 bg-gradient-to-b from-white/5 to-white/0 p-2 sm:h-96 sm:w-96">
